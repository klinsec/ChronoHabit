  ...
  return (
    <div className="space-y-6 pb-4">
      {activeEntry && activeTask && (
        <div>
          <h2 className="text-lg font-semibold text-gray-300 mb-3 sticky top-0 bg-bkg py-2">Ahora</h2>
      ...
      {Object.keys(groupedEntries).length > 0 ? Object.keys(groupedEntries).map(date => (
        <div key={date}>
          <h2 className="text-lg font-semibold text-gray-300 mb-3 sticky top-0 bg-bkg py-2">{date}</h2>
